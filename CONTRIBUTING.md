...
- Keep CMake builds and compiler assumptions documented.
...
For C++ changes, build the relevant target and include compiler/platform details in the pull request.
